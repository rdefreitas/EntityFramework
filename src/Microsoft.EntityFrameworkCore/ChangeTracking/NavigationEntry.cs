    ...
    public abstract class NavigationEntry : MemberEntry
    {
        ...
        private static INavigation GetNavigation(InternalEntityEntry internalEntry, string name, bool collection)
        {
            ...
            if (navigation == null)
            {
                ...
                {
                    throw new InvalidOperationException(CoreStrings.NavigationIsProperty(name, internalEntry.EntityType.DisplayName()));
                }
            ...
            {
                throw new InvalidOperationException(CoreStrings.CollectionIsReference(name, internalEntry.EntityType.DisplayName()));
            }

            if (!collection
                && navigation.IsCollection())
            {
                throw new InvalidOperationException(CoreStrings.ReferenceIsCollection(name, internalEntry.EntityType.DisplayName()));
            }
